...
@click.command()
@click.option('--standings', '-s', multiple=False, is_flag=True, help='Current league standings for a particular league')
...
@click.option('--league', '-l', help='Specific league code to retrieve results for', type=click.Choice(config.LEAGUE_IDS.keys()))
